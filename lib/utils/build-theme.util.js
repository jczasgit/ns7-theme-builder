...
exports.hsl2Rgb = exports.rgb2Hsl = exports.hsv2Rgb = exports.alphaUtility = exports.hex2Rgb = exports.rgb2Hsv = exports.colorUtility = exports.rgb2Hex = exports.buildTheme = void 0;
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    filename = 'custom.css';
                    writeStream = fs_1.default.createWriteStream(path_1.default.join(theme.destination, filename), {
                        flags: 'a',
                        encoding: 'utf-8',
                    });
                    _a.label = 1;
...
function _writeThemeColorVariables(ws, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var lightVariableNames, _i, lightVariableNames_1, _a, name_1, color, darkVariableNames, _c, darkVariableNames_1, _d, name_2, color, error_4;
        return __generator(this, function (_e) {
            switch (_e.label) {
                case 0:
                    _e.trys.push([0, 9, , 10]);
                    console.log(chalk_1.default.green('Setting light theme color variables...'));
                    lightVariableNames = Object.entries(t.light);
                    _i = 0, lightVariableNames_1 = lightVariableNames;
                    _e.label = 1;
                case 1:
                    if (!(_i < lightVariableNames_1.length)) return [3 /*break*/, 4];
                    _a = lightVariableNames_1[_i], name_1 = _a[0], color = _a[1];
                    name_1 = name_1.replace(/([A-Z])/g, ' $1').toLowerCase().replace(/\s/g, '-');
                    return [4 /*yield*/, _write(ws, "--light-" + name_1 + ": " + color + "; ")];
                case 2:
                    _e.sent();
                    _e.label = 3;
                case 3:
                    ...
                    return [3 /*break*/, 1];
                case 4:
                    console.log(chalk_1.default.green('Setting dark theme color variables...'));
                    darkVariableNames = Object.entries(t.dark);
                    _c = 0, darkVariableNames_1 = darkVariableNames;
                    _e.label = 5;
                case 5:
                    if (!(_c < darkVariableNames_1.length)) return [3 /*break*/, 8];
                    _d = darkVariableNames_1[_c], name_2 = _d[0], color = _d[1];
                    name_2 = name_2.replace(/([A-Z])/g, ' $1').toLowerCase().replace(/\s/g, '-');
                    return [4 /*yield*/, _write(ws, "--dark-" + name_2 + ": " + color + "; ")];
                case 6:
                    _e.sent();
                    _e.label = 7;
                case 7:
                ...
                case 9:
                    error_4 = _e.sent();
                    reject("\"Error setting theme color variables.\" ERROR: " + error_4);
                    return [3 /*break*/, 10];
...
function _writeCommons(ws, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var entries, _i, entries_1, _a, key, value, error_5;
        return __generator(this, function (_c) {
            switch (_c.label) {
                ...
                case 4:
                    _i++;
                    return [3 /*break*/, 2];
                case 5: return [4 /*yield*/, _writeThemeColorVariables(ws, t)];
                case 6:
                    _c.sent();
                    return [4 /*yield*/, _writeExtraColors(ws, t)];
                case 7:
                    _c.sent();
                ...
                case 9:
                    error_5 = _c.sent();
                    reject("\"Error setting common variables.\" ERROR: " + error_5);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeActionBar(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, _i, classes_1, _class, line, _a, _c, _property, dark_classes, _d, dark_classes_1, _class, line, _e, _f, _property, error_6;
        return __generator(this, function (_h) {
            switch (_h.label) {
                ...
                case 9:
                    error_6 = _h.sent();
                    reject("\"Error applying ActionBar theme.\" ERROR: " + error_6);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeDataFormEditorLabel(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var light_class, dark_class, error_7;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 3:
                    error_7 = _a.sent();
                    reject("\"Error applying DataFormEditorLabel theme.\" ERROR: " + error_7);
                    return [3 /*break*/, 4];
...
function _writeDateTimePicker(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, _i, classes_2, _class, line, _a, _c, _property, dark_classes, _d, dark_classes_2, _class, line, _e, _f, _property, error_8;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    _h.trys.push([0, 9, , 10]);
                ...
                case 9:
                    error_8 = _h.sent();
                    reject("\"Error applying DateTimePicker theme.\" ERROR: " + error_8);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writePickerPage(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, _i, classes_3, _class, line, _a, _c, _property, dark_classes, _d, dark_classes_3, _class, line, _e, _f, _property, error_9;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    _h.trys.push([0, 9, , 10]);
                ...
                case 9:
                    error_9 = _h.sent();
                    reject("\"Error applying PickerPage theme.\" ERROR: " + error_9);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeRadDataForm(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, _i, classes_4, _class, line, _a, _c, _property, dark_classes, _d, dark_classes_4, _class, line, _e, _f, _property, error_10;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    _h.trys.push([0, 9, , 10]);
                ...
                case 9:
                    error_10 = _h.sent();
                    reject("\"Error applying RadDataForm theme.\" ERROR: " + error_10);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeRadAutoCompleteTextView(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, _i, classes_5, _class, line, _a, _c, _property, dark_classes, _d, dark_classes_5, _class, line, _e, _f, _property, error_11;
        return __generator(this, function (_h) {
            switch (_h.label) {
                case 0:
                    _h.trys.push([0, 9, , 10]);
                ...
                case 9:
                    error_11 = _h.sent();
                    reject("\"Error applying RadAutoCompleteTextView theme.\" ERROR: " + error_11);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writePropertyEditor(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var light_class, dark_class, error_12;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 3:
                    error_12 = _a.sent();
                    reject("\"Error applying PropertyEditor theme.\" ERROR: " + error_12);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
...
function _writeTextView(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, i, line, j, dark_classes, i, line, j, error_13;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 9, , 10]);
                ...
                case 9:
                    error_13 = _a.sent();
                    reject("\"Error applying TextView theme.\" ERROR: " + error_13);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeForm(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, i, line, j, dark_class, error_14;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                ...
                case 6:
                    error_14 = _a.sent();
                    reject("\"Error applying From theme.\" ERROR: " + error_14);
                    return [3 /*break*/, 7];
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 9:
                    error_15 = _a.sent();
                    reject("\"Error applying RadSideDrawer theme.\" ERROR: " + error_15);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 9:
                    error_16 = _a.sent();
                    reject("\"Error applying ListView theme.\" ERROR: " + error_16);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 9:
                    error_18 = _a.sent();
                    reject("\"Error applying TabView theme.\" ERROR: " + error_18);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeSwitch(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, i, line, j, dark_classes, i, line, j, error_19;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 9, , 10]);
                ...
                case 9:
                    error_19 = _a.sent();
                    reject("\"Error applying switch theme.\" ERROR: " + error_19);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeSearchBar(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var _class, line, i, dark_class, i, error_20;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 3:
                    error_20 = _a.sent();
                    reject("\"Error applying search bar theme.\" ERROR: " + error_20);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
...
function _writeSlider(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, i, line, isEnabled, j, dark_classes, i, line, isEnabled, j, error_21;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 9, , 10]);
                ...
                case 9:
                    error_21 = _a.sent();
                    reject("\"Error applying slider theme.\" ERROR: " + error_21);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeProgress(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var _class, line, i, dark_class, i, error_22;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 3:
                    error_22 = _a.sent();
                    reject("\"Error applying progress theme.\" ERROR: " + error_22);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 9:
                    error_23 = _a.sent();
                    reject("\"Error applying segmented bar theme.\" ERROR: " + error_23);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeActivityIndicator(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, i, line, j, dark_classes, i, line, j, error_24;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 9, , 10]);
                ...
                case 9:
                    error_24 = _a.sent();
                    reject("\"Error applying activity indicator light theme.\" ERROR: " + error_24);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
...
function _writeButton(ws, c, t) {
    var _this = this;
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        var classes, i, line, isOutlineButton, isOutlineButtonActive, j, color, rgb_1, hsl, dark_classes, i, line, isOutlineButton, isOutlineButtonActive, j, color, rgb_2, hsl, error_25;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 9, , 10]);
                    ...
                    for (j = 0; j < c.light.Button[classes[i]].length; j += 1) {
                        switch (c.light.Button[classes[i]][j]) {
                            case 'background-color':
                                color = void 0;
                                if (isOutlineButton)
                                    color = t.light.background;
                                else if (isOutlineButtonActive)
                                    color = colorUtility(t.light.background, -0.3);
                                else
                                    color = t.light.primary;
                                line = line + ("background-color: " + color + "; ");
                                break;
                            case 'color':
                                rgb_1 = hex2Rgb(t.light.primary);
                                hsl = rgb2Hsl(rgb_1.r, rgb_1.g, rgb_1.b);
                                line = line + ("color: " + (math_util_1.round(hsl.l, 1) < 0.5 ? colorUtility(t.light.textColor, 0.5) : colorUtility(t.light.textColor, -0.8)) + "; ");
                                break;
                            case 'animation':
                    ...
                    for (j = 0; j < c.dark.Button[dark_classes[i]].length; j += 1) {
                        switch (c.dark.Button[dark_classes[i]][j]) {
                            case 'background-color':
                                color = void 0;
                                if (isOutlineButton)
                                    color = t.dark.background;
                                else if (isOutlineButtonActive)
                                    color = colorUtility(t.dark.background, 0.3);
                                else
                                    color = t.dark.backgroundAlt5;
                                line = line + ("background-color: " + color + "; ");
                                break;
                            case 'color':
                                rgb_2 = hex2Rgb(t.dark.backgroundAlt5);
                                hsl = rgb2Hsl(rgb_2.r, rgb_2.g, rgb_2.b);
                ...
                case 9:
                    error_25 = _a.sent();
                    reject("\"Error applying light theme colors to Button.\" ERROR: " + error_25);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
    ...
    return new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 11:
                    error_26 = _a.sent();
                    reject("\"Error Writing keyframes.\" ERROR: " + error_26);
                    return [3 /*break*/, 12];
...
function hsl2Rgb(hsl) {
    ...
    return { r: math_util_1.round(r * 255), g: math_util_1.round(g * 255), b: math_util_1.round(b * 255) };
}
...
function _themeObjectFactory(answers) {
    var theme = {
        ...
        dark: {
            ...
            btnColorInverse: invert_color_1.default(answers.darkBtnColor),
